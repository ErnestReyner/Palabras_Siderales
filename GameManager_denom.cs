...
public class GameManager_denom : MonoBehaviour
{
    ...
    public GameObject Game_Manager_denom;
    ...
    void Awake ()
    {
        firebaseManager = Game_Manager_denom.GetComponent<FirebaseManager>();
    }
    ...
    void Start()
    {
        ...
        hints.Add("Lo utilizamos para lavarnos"); //jabon
        ...
        instructions.Add("¡Mmm! He recuperado energía gracias a la comida de la cocina, ¿pero dónde estoy ahora?");
        Tutorial(0);

...
public class GM_profesiones : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        hints.Add("Profesional de la salud que ayuda a las personas a curar enfermedades"); //médico H
        hints.Add("Persona que enseña una ciencia o arte"); //profesora M
        hints.Add("Persona que canta por profesión"); //cantante M
        hints.Add("Persona que mantiene el orden público y la seguridad de los ciudadanos"); //policia M
        hints.Add("Persona que cocina los alimentos por profesión"); //cocinera M
        hints.Add("Persona que cuida y cultiva un jardín por profesión"); //jardinero H
        hints.Add("Persona que juega al fútbol"); //futbolista H
        ...
        hints.Add("Artista de circo que hace reír con su aspecto, actos, dichos y gestos"); //payaso H

        wordsToPick.Add("profesora \n \n médico \n \n policía"); //medico
        wordsToPick.Add("médico \n \n cantante \n \n profesora"); //profesora
        wordsToPick.Add("policía \n \n cantante \n \n cocinera"); //cantante
        wordsToPick.Add("policía \n \n jardinero \n \n cocinera"); //policia
        ...
        instructions.Add("Ahora ya sé qué tipos de seres humanos hay, ¿pero a qué se dedican?");
        Tutorial(0);

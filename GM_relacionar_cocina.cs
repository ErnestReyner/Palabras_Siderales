...
public class GM_relacionar_cocina : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        hints.Add("Recipiente normalmente de vidrio que sirve para beber líquidos"); //vaso
        hints.Add("Recipiente plano que se utiliza para servir los alimentos y comer en él"); //plato
        ...
        hints.Add("Vasija con asa que sirve para beber líquidos"); //taza
        hints.Add("Cubierto que sirve para llevar a la boca cosas líquidas"); //cuchara
        hints.Add("Recipiente que contiene dentro suyo algún tipo de líquido"); //botella
        hints.Add("Cubierto que sirve para comer alimentos sólidos"); //tenedor
        hints.Add("Recipiente de metal que sirve para freír alimentos"); //sartén
        ...
        instructions.Add("Ahora ya conozco algunos alimentos de la Tierra, ¿pero qué son los otros objetos?");
        Tutorial(0);

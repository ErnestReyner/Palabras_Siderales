...
public class GM_def_humanos : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        hints.Add("Palabra similar a: cría, nena o chica");
        hints.Add("Palabra similar a varón o señor");
        hints.Add("Palabra similar a vieja o abuela");
        hints.Add("Palabra similar a: infante, criatura o chiquitín");
        hints.Add("Palabra similar a viejo o abuelo");
        hints.Add("Palabra similar a hembra o señora");
        hints.Add("Palabra similar a: crío, nene o chico");

        sentences.Add("Ser humano pequeño del sexo femenino que está creciendo"); //niña
        sentences.Add("Ser humano del sexo masculino");  //hombre
        sentences.Add("Ser humano del sexo femenino de mucha edad"); //anciana
        sentences.Add("Ser humano recién nacido"); //bebé
        sentences.Add("Ser humano del sexo masculino de mucha edad"); //anciano
        sentences.Add("Ser humano del sexo femenino"); //mujer
        sentences.Add("Ser humano pequeño del sexo masculino que está creciendo"); //niño

        instructions.Add("He logrado salir al mundo exterior gracias a tu ayuda, ¿pero qué tipo de seres viven en este planeta?");
        Tutorial(0);
    ...
    public void Success()
    {
        ...
        finalScoreText.text = " * Puntuación final: " + score + "/7";

...
public class GM_contar_silabas : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        hints.Add("Ser humano recién nacido"); //bebé
        hints.Add("Artista de circo que hace reír con su aspecto, actos, dichos y gestos"); //payaso
        ...
        hints.Add("Persona que juega al fútbol"); //futbolista
        hints.Add("Conjunto de pelos de la cabeza"); //cabello
        hints.Add("Persona que cocina los alimentos por profesión"); //cocinera
        ...
        instructions.Add("Vamos a practicar los números con algunas de las palabras que he aprendido recientemente");
        Tutorial(0);

...
public class GM_denom_transporte : MonoBehaviour
{
    ...
    public GameObject Game_Manager_transporte;
    ...
    private string gameID = "Nivel 11";
    ...
    void Awake()
    {
        firebaseManager = Game_Manager_transporte.GetComponent<FirebaseManager>();
    }
    ...
    void Start()
    {
        ...
        hints.Add("Automóvil de cuatro ruedas que transporta personas"); //coche
        hints.Add("Aeronave con alas y motores que transporta personas"); //avion
        hints.Add("Vehículo de motor con dos ruedas"); //moto
        hints.Add("Embarcación grande que flota en el agua del mar"); //barco
        hints.Add("Vehículo largo de cuatro o más ruedas que transporta grandes cargas"); //camion
        hints.Add("Medio de transporte formado por vagones que circula sobre raíles"); //tren
        hints.Add("Aeronave que vuela verticalmente gracias a sus aspas giratorias"); //helicoptero
        hints.Add("Vehículo largo destinado al transporte público"); //autobus
        hints.Add("Nave capaz de sumergirse y desplazarse debajo del agua"); //submarino
        hints.Add("Vehículo de dos ruedas que se mueve mediante pedales"); //bicicleta

        instructions.Add("¿Y cómo hacen los humanos para desplazarse? ¿Tienen cohetes interestelares como el mío?");
        Tutorial(0);
